    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-400 mt-2">{isSignUp ? 'Create an account' : 'Sign in to continue'}</p>
        </div>
        ...
        <button
          ...
          className="w-full py-2 rounded-lg bg-slate-800 text-slate-200 font-medium hover:bg-slate-700 transition-colors flex items-center justify-center gap-2"
        >
